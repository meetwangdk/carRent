...
public class BusController {
     ...
     * @return
     */
    @RequestMapping("toRentMyselfCarManager")
    public String toRentMyselfCarManager(){
        return "business/rent/rentMyselfCarManager";
    }
     ...
     * @return
     */
    @RequestMapping("toCustomerRentManager")
    public String toCustomerRentManager(){
        return "business/rent/customerRentManage";
    }
