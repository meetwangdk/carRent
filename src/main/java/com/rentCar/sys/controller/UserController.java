...
public class UserController {
     ...
     * @return
     */
    @RequestMapping("resetCustPwd")
    public ResultObj resetCustPwd(UserVo userVo){
        try {
            this.userService.resetCustPwd(Integer.valueOf(userVo.getIdentity()));
            return ResultObj.RESET_SUCCESS;
        }catch (Exception e){
            return ResultObj.RESET_ERROR;
        }
     ...
     * @return
     */
    @RequestMapping("updateCustPwdByIdentity")
    public ResultObj updateCustPwdByIdentity(String identity,String newPwd){
        try {
            this.userService.updateCustPwdByIdentity(identity,newPwd);
            return ResultObj.RESET_SUCCESS;
        }catch (Exception e){
            return ResultObj.RESET_ERROR;
        }
