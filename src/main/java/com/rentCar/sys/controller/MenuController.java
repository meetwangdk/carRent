...
import com.rentCar.sys.service.MenuService;
import com.rentCar.sys.utils.*;
import com.rentCar.sys.vo.MenuVo;
...
public class MenuController {
     ...
     * @return 跳转到密码修改的方法
     */
    /*@RequestMapping("updateCustPwd")
    public ModelAndView toLogin(){
        ModelAndView mv = new ModelAndView();
        mv.setViewName("/system/main/changePwd");
        return mv;
    }*/
