...
<body class="loginBody loginBody1">
<br><br>
<h1 align="center"  style="color:LightSteelBlue ; font-size: 50px">婚庆用车服务平台</h1>
	<br><br>
...
<%--			<a href="register.jsp" class="layui-btn layui-block" id="register" >注册</a>--%>
		</div>
	...
	layui.use(['form','layer','jquery'],function(){
		...
		$("#register").on('click',function () {
			$.ajax({
				url:"/register/toRegister.action",
				method:"get",
