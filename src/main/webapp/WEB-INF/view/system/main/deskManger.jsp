...
<script>
    ...
    function getLangDate(){
        ...
        document.getElementById("nowTime").innerHTML = "亲爱的${user.realname}，"+timeValue+"好！ 欢迎使用婚庆用车服务平台。当前时间为： "+newDate+"　"+week + "  ， 如有问题请致电客服电话 ：88888888 ";
    ...
    layui.use(['form','element','layer','jquery'],function(){
        ...
        $.get("${alfred}/news/loadAllNews.action?page=1&limit=10",function(data){
            ...
            for(var i=0;i<data.data.length;i++){
                console.log("苏苏苏-----------------"+data.data[i].id);
