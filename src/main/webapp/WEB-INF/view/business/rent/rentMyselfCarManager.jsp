...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>欢迎您使用租赁平台租赁婚车！如有问题请致电客服电话：88888888</legend>
</fieldset>
    ...
    <div class="layui-form-item">
           <div class="layui-inline">
               ...
               <div class="layui-input-inline">
                   <select name="modules"  lay-search="" id="typeSelect" onchange="dochange()">
           ...
           <div class="layui-inline">
               ...
               <div class="layui-input-inline">
                   <select name="modules"  lay-search="" id="colorSelect">
                       <option value="">直接选择或搜索选择</option>
                   </select>
               </div>
            </div>

           <button type="button" class="layui-btn layui-btn-radius" id="searchBy">条件搜索</button>
           <button type="reset"
...
<div id="content" style="display: none;">
    ...
    <div id="carBar" style="display: none;">
        <a class="layui-btn layui-btn-warm layui-btn-xs layui-btn-radius" lay-event="rentCar">加入待租赁列表</a>
    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        ...
        <div class="layui-form-item">
            <div class="layui-inline" style="display:none">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="identity" value="${user.identity}" name="identity" lay-verify="required" readonly="readonly" placeholder="请输入身份证号" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input readonly  unselectable="on" type="text" name="price" lay-verify="required" placeholder="请输入出租价格" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function initCarData() {
            ...
            tableIns = table.render({
                ...
                , url: '${alfred}/car/loadAllCar.action?isrenting=0&identity=${user.identity}' //数据接口
                , title: '车辆列表'//数据导出来的标题
                , height: 'full-150'
                , page: true  //是否启用分页
                , cols: [[   //列表数据
        ...
        function initCarDataSearch() {
            //渲染数据表格
            var type = $("#typeSelect").val();
            var color = $("#colorSelect").val();
            tableIns = table.render({
                elem: '#carTable'   //渲染的目标对象
                , url: '${alfred}/car/loadAllCar.action?isrenting=0&identity=${user.identity}&cartype='+type+'&color='+color+'' //数据接口
                , title: '车辆列表'//数据导出来的标题
                , height: 'full-150'
                , page: true  //是否启用分页
                , cols: [[   //列表数据
        ...
        $(document).ready(function () {
            $.ajax({
                url:"/car/CarGroupByType.action",
                type:"get",
                dataType:"json",
                success:function (data) {
                    var optionHtml = '';
                    $.each(data,function (index,obj) {
                        optionHtml += "<option value='" + obj.cartype + "'>" + obj.cartype + "</option>";
                    });
                    $("#typeSelect").append(optionHtml);
                    layui.form.render('select');
                }
            })
            $.ajax({
                url:"/car/CarGroupByColor.action",
                type:"get",
                dataType:"json",
                success:function (data) {
                    var optionHtml = '';
                    $.each(data,function (index,obj) {
                        optionHtml += "<option value='" + obj.color + "'>" + obj.color + "</option>";
                    });
                    $("#colorSelect").append(optionHtml);
                    layui.form.render('select');
                }
            })
        })
