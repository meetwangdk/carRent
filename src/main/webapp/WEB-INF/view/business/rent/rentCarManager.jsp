    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="price" id="price" lay-verify="required" placeholder="请输入出租价格" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        form.on("submit(doSubmit)", function (obj) {
            ...
            let beginTimes =  new Date($("#begindate").val()).getTime();
            let endTimes =  new Date($("#returndate").val()).getTime();
            if (endTimes-beginTimes < 1000*60*60*24 ){
                layer.msg("起租时间需小于还车时间，且租赁天数至少为1天");
                return;
            }
